    ...
    switch (m_spellInfo->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_PALADIN:
            ...
            if (m_spellInfo->SpellFamilyFlags[EFFECT_1] & SPELLFAMILYFLAG1_PALADIN_DIVINESTORM)
            {
                ...
                if (Aura * aura = m_caster->AddAura(99997, unitTarget))
...
void Spell::EffectApplyAura(SpellEffIndex effIndex)
{
    ...
    switch (m_spellInfo->Id)
    {
        case 16870: // Druid: T10 Balance 2P Bonus
        {
...
void Spell::EffectEnchantItemPerm(SpellEffIndex effIndex)
{
    ...
    else
    {
        ...
        if (item_owner != p_caster && p_caster->GetSession()->GetSecurity() > SEC_VIP && sWorld->getBoolConfig(CONFIG_GM_LOG_TRADE))
        {
        ...
        case SPELLFAMILY_GENERIC:
        {
            switch(m_spellInfo->Id)
            {
                ...
                case 70117:                                 // Ice grip (Sindragosa pull effect)
                {
                    ...
                    m_caster->GetRandomPoint(pos, m_caster->GetObjectSize(), fPosX, fPosY, fPosZ);
