...
int Master::Run()
{
    ...
    sLog->outString("                      /\\__/ W O R L D");
    sLog->outString("                      \\/_/\n");
    sLog->outString("* Private Version * Power Of the Community *");
    sLog->outString("      * Based on TrinityCore Source *");
    sLog->outString("        * Join US! * Myth Project *\n");
    sLog->outString(" Repository: https://bitbucket.org/sun/myth-core \n");
...
bool Master::_StartDB()
{
    ...
    sLog->outString("Realm ID: %d", realmID);
