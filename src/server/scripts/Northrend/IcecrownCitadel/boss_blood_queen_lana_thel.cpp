...
class spell_blood_queen_bloodbolt_whirl : public SpellScriptLoader
{
    public:
        spell_blood_queen_bloodbolt_whirl() : SpellScriptLoader("spell_blood_queen_bloodbolt_whirl") { }

        class spell_blood_queen_bloodbolt_whirl_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_blood_queen_bloodbolt_whirl_SpellScript);
            ...
            void HandleDummy()
            {
                ...
                {
                    if(caster->GetDistance2d(target) < 3.0f)
                        SetHitDamage(0);
                }
            }
            ...
            void Register()
            {
                BeforeHit += SpellHitFn(spell_blood_queen_bloodbolt_whirl_SpellScript::HandleDummy);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_blood_queen_bloodbolt_whirl_SpellScript();
        }
};
