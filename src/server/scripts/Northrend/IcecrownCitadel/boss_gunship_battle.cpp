...
class spell_gb_burning_pitch : public SpellScriptLoader
{
    public:
        ...
        class spell_gb_burning_pitch_SpellScript : public SpellScript
        {
            ...
            {
                if (!GetSpellStore()->LookupEntry(SPELL_BURNING_PITCH_SIEGE_DMG_A))
                    return false;
                if (!GetSpellStore()->LookupEntry(SPELL_BURNING_PITCH_SIEGE_DMG_H))
                    return false;
                if (!GetSpellStore()->LookupEntry(SPELL_BURNING_PITCH_AOE_DAMAGE))
                    return false;
                return true;
            }
