...
enum DataTypes
{
    ...
    DATA_LAVAMAN = 41,
    DATA_HANGINGMAN = 42,
    DATA_FROSTY_EDGE_OUTER = 43,
    DATA_FROSTY_EDGE_INNER = 44,
    DATA_EDGE_DESTROY_WARNING = 45,
    DATA_TIRION = 48,
    DATA_TERENAS_FIGHTER = 49,
    DATA_SPIRIT_WARDEN = 50,
    DATA_PORTAL_JOCKEY_ACHIEVEMENT = 51,
    DATA_NECK_DEEP_ACHIEVEMENT = 52,
    DATA_BEEN_WAITING_ACHIEVEMENT = 53,
    DATA_IS_SINDRAGOSA_SPAWNED = 54,
    DATA_VALITHRIA_ALTERNATIVE = 55,
