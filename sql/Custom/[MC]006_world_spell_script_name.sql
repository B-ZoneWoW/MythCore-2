DELETE FROM spell_script_names WHERE spell_ip IN (50365,50371,50391,50392,13191)
...
DELETE FROM spell_script_names WHERE spell_id IN (20911,25899,63944,68066);
